#include<cstdio>
#include<cstdlib>
int R,C,H_SUM[5000][100],H[5000][100],V_SUM[5000][100],V[5000][100],TMP_ARRAY[100][100],TMP_ARRAY2[100][100],TMP_ARRAY3[100][100];
...
inline void get_rowdis(int r,int ans[100][100])
{
    for(int i=0;i<C;i++)
    {
