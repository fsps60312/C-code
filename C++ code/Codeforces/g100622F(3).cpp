...
long long DistLL(const double x1,const double y1,const double x2,const double y2)
{
	return Hypot((long long)(x1+(x1>0.0?0.5:-0.5))-(long long)(x2+(x2>0.0?0.5:-0.5)),(long long)(y1+(y1>0.0?0.5:-0.5))-(long long)(y2+(y2>0.0?0.5:-0.5)));
}
int main()
{
