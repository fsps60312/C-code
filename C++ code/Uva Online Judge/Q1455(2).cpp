...
void update(int i1,int i2)
{
    if(i1==i2)return;
    //clear data of C[i1]
    if(C[i1].ys<C[i1].yl)addv(1,0,999999,C[i1].ys,C[i1].yl-1,-1,-C[i1].sum);
    //clear data of C[i2]
    if(C[i2].ys<C[i2].yl)addv(1,0,999999,C[i2].ys,C[i2].yl-1,-1,-C[i2].sum);
    //insert data to C[i1]
    C[i2].head=i1;
