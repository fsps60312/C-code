...
int Vis(int i){return VIS[i/32]&(1<<(i%32));}
void Vis(int i,int v)
{
	if(v)VIS[i/32]|=(1<<(i%32));
	else VIS[i/32]|=~(1<<(i%32));
}
void ClearVis(){for(int i=0,limit=(A-1)/32;i<=limit;i++)VIS[i]=0;}
int Dis(int s,int t)
{
