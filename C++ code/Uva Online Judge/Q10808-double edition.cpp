...
bool iszero(double a){return a>=-1e-10&&a<=1e10;}
struct Matrix
{
	LL nn,mm;
	fraction s[200][200];
...
int main()
{
	...
	for(LL kase=1;kase<=T;kase++)
	{
		...
		while(Q--)
		{
			...
			{
		//printf("%lld %lldelse\n",a,b);
				fraction ans=solve(a,b);
				printf("Resistance between %lld and %lld is %.10lf\n",a,b,ans);
			}
		}
	}
	return 0;
